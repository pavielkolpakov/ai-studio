...
export function BookCta() {
  return (
    <section className="mx-auto mt-[120px] max-w-[1200px] px-5 sm:px-10">
      <div className="grid items-center gap-10 rounded-[20px] border border-hairline-strong bg-[linear-gradient(140deg,rgba(212,175,55,0.10)_0%,rgba(212,175,55,0.02)_44%,#0F0F11_100%)] px-7 py-12 sm:px-14 sm:py-16 lg:grid-cols-[minmax(0,1fr)_minmax(260px,340px)] lg:gap-14">
        <div>
