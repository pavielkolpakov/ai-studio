  ...
  if (isUser) {
    return (
      <div className="idea-card-reveal flex justify-end mb-4">
        <div className="max-w-[80%] rounded-[14px] rounded-br-[5px] border border-silver/[0.18] bg-gradient-to-br from-silver/[0.10] to-silver/[0.03] px-4 py-3 text-foreground">
