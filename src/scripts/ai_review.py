...
- If reasoning is needed, give the conclusion only.
</finding_body_style>"""
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "body": {
                            "type": "string",
                            "description": (
                                "Terse finding. One sentence stating the bug, optionally followed by a single "
                                "'Fix: ...' line. No restating code, no chained reasoning ('that means', "
                                "'because of it'), no preamble."
                            ),
                        },
                    },
